...
public class AopoloAdapter extends BaseAdapter {
    Context context;
    ArrayList<Sanpham> arraylaptop;

    public AopoloAdapter(Context context, ArrayList<Sanpham> arraylaptop) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        AopoloAdapter.ViewHolder viewHolder = null;
        //mở lần đầu
        if (view == null){
            ...
            viewHolder= (AopoloAdapter.ViewHolder) view.getTag();
        }
