...
public class AoThunSweaterActivity extends AppCompatActivity {
    ...
    AoThunSweaterActivity.mHandler mHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ao_thun_sweater);
        Anhxa();
                ...
                if (response != null && response.length() != 2) //Khi object trả về =2 thì nó hết giá trị rồi
                {
                    ...
                    try {
                        ...
                        for (int i = 0; i<response.length(); i++){
                            ...
                            mangdt.add(new Sanpham(id, Tendt, Giadt,null, Hinhanhdt, Mota,0, Idspdt));
    ...
    private void Anhxa() {
        toolbardt= findViewById(R.id.toolbaraosweater);
        lvdt= findViewById(R.id.listviewdaosweater);
        mangdt= new ArrayList<>();
        aothunAdapter = new AothunAdapter(getApplicationContext(), mangdt);
