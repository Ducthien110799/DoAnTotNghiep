...
public class LienheActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng cafekien = new LatLng(10.87623934660391, 106.63022440574494);
        mMap.addMarker(new MarkerOptions().position(cafekien).title("TWestside Shop").icon(BitmapDescriptorFactory.defaultMarker()));
        //bản đồ bình thường
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);

        //zoom bản đồ
        CameraPosition cameraPosition= new CameraPosition.Builder().target(cafekien).zoom(10).build();
